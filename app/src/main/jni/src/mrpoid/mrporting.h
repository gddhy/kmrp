...
#define mr_log_file "c/printf.txt"
...
//通过入口参数来启动虚拟机。
extern int32 mr_start_dsmC(const char* start_file,const char* entry);
...
extern int mr_sprintf(char *str, char *format, ...);
